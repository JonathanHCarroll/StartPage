 ...
 *   COLLECTION_IDS        — Comma-separated Raindrop collection IDs to show
 *
 * Optional:
 *   BOOKMARKS_PER_PAGE — Max bookmarks per collection (1–40, default 40)
...
var CONFIG = (function () {
  ...
  return {
    ...
    getBookmarksPerPage: function () {
      return getInt_('BOOKMARKS_PER_PAGE', 40, 1, 40);
    },
